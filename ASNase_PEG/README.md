...
- **ASNase_K29_ASN**
- **ASNase_K207_ASN**
Within each folder, contains \* alignment file for structure alighnemt for RMSD calculation and definition of the funnel shaped potential, plumed_FM_*.dat file input file for FM, and plumed_FM_*_reweight.dat file for reweighting and get 2D free energy profile.
...
- **PSF_Ca.py**  
  **Calculate partial structure factor between different component of the sysytem**
